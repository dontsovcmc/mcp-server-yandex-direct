...
- **Таблицы без дублей.** Не создавать столбцы с идентичным содержимым. В таблице «Возможности» — один столбец «Команда», поскольку Action ID и CLI-команда совпадают.
